...
**Личный финансовый кабинет с AI-аналитикой, распознаванием чеков и полной адаптивностью.**
...
FinTech Dashboard — единое окно для учёта финансов с AI-помощником. Загрузите чек — AI сам распознает сумму, магазин и категорию. Спросите ассистента — он проанализирует ваши траты и даст совет. Всё работает бесплатно, на русском языке, на компьютере и телефоне.
...
- **📸 Распознавание чеков** — сфотографируйте чек, AI заполнит форму (OpenRouter Vision)
...
|--------|------|----------|
| **Виджеты** | `widgets/` | Dashboard, AI-чат, AI-инсайты, графики, таблицы |
...
| **API Routes** | `app/api/` | Эндпоинты чата, vision, транзакций, авторизации |
...
- **OpenRouter API** — облачные AI-модели
  ...
  - `qwen-vl-plus:free` — распознавание чеков (Vision)
...
OPENROUTER_VISION_MODEL="qwen-vl-plus:free"
```
...
| Распознавание чеков | `qwen-vl-plus:free` | Мультимодальная (текст + изображения) |
